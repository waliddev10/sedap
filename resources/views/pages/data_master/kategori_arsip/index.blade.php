...
@section('title', 'Master Data Kategori arsip')
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Master Data Kategori arsip</h5>
            </div>
            <div class="card-body">
                <a class="btn btn-primary btn-sm" title="Tambah Kategori arsip" data-bs-toggle="modal"
                    data-bs-target="#modalContainer" data-title="Tambah Kategori arsip"
                    href="{{ route('kategori_arsip.create') }}"><i class="fa fa-plus fa-fw"></i>
                    Tambah
                    Kategori arsip</a>
...
<script type="text/javascript">
    var tableDokumen = $('#tableDokumen').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('kategori_arsip.index') }}',
            // data: function (d) {
