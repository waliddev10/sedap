            ...
            <div class="card">
                <div class="card-body">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('dashboard.show', $kategori->id) }}" class="btn btn-light">
                                {{ $kategori->nama }}
                            </a>
                        </li>
                        @endforeach
        ...
        <div class="file-content">
            <div class="card">
                <div class="card-header">
                    <div class="media">
                        <form class="form-inline" action="{{ route('dashboard.index') }}" method="get">
                            <div class="form-group mb-0">
                                <i class="fa fa-search"></i>
                                <input name="search" class="form-control-plaintext" type="text"
                                    placeholder="Cari tahun atau judul..." value="{{ request()->search }}">
                            </div>
